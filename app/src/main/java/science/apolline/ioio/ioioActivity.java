...
import science.apolline.contact;
import science.apolline.informations;
import science.apolline.options;


////////////////////////////////////////////////////////////////////////////////////////////////////
@Deprecated
public class ioioActivity extends AppCompatActivity {
    ...
    private ProgressBar pm1;
    private ProgressBar pm2;
    private ProgressBar pm10;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        graph = (GraphView) findViewById(R.id.fragment_ioio_graph);
        initGraph(graph);
        pm1 = (ProgressBar) findViewById(R.id.fragment_ioio_progress_pm1);

        textViewPM1 = (TextView) findViewById(R.id.fragment_ioio_tv_pm1_value);
        textPM1 = (TextView) findViewById(R.id.fragment_ioio_tv_pm1_label);
        pm2 = (ProgressBar) findViewById(R.id.fragment_ioio_progress_pm2);
        textViewPM2 = (TextView) findViewById(R.id.fragment_ioio_tv_pm2_value);
        textPM2 = (TextView) findViewById(R.id.fragment_ioio_tv_pm2_label);
        pm10 = (ProgressBar) findViewById(R.id.fragment_ioio_progress_pm10);
        textViewPM10 = (TextView) findViewById(R.id.fragment_ioio_tv_pm10_value);
        textPM10 = (TextView) findViewById(R.id.fragment_ioio_tv_pm10_label);
        ...
        pieton = (Button) findViewById(R.id.fragment_ioio_pieton);
        velo = (Button) findViewById(R.id.fragment_ioio_velo);
        voiture = (Button) findViewById(R.id.fragment_ioio_voiture);
        other = (Button) findViewById(R.id.fragment_ioio_other);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_ioio, menu);
        return true;
    }
