...
import science.apolline.view.activity.Main2Activity
...
class IOIOFragment : RootFragment(), FragmentLifecycle, AnkoLogger {
    ...
    override fun onStart() {
        ...
        if(this.deviceName.toLowerCase().contains(regex = "^ioio.".toRegex())) {
            ...
            println("fragment blablahg " + MainActivity.mBluetoothLeService )
            /*pm01 = MainActivity.mBluetoothLeService!!.appaData.pm01Value
            pm25 = MainActivity.mBluetoothLeService!!.appaData.pm2_5Value
            pm10 = MainActivity.mBluetoothLeService!!.appaData.pm10Value


            fragment_ioio_progress_pm1.setValueAnimated(pm01.toFloat())
            fragment_ioio_progress_pm2_5.setValueAnimated(pm25.toFloat())
            fragment_ioio_progress_pm10.setValueAnimated(pm10.toFloat())
            fragment_ioio_progress_rht.setValueAnimated(0.0f)
            fragment_ioio_progress_tmpk.setValueAnimated(0.0f)
            fragment_ioio_progress_tmpc.setValueAnimated(0.0f)*/
        }
        info("onStart")
    }
