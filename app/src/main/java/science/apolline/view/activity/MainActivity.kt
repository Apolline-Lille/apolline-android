...
class MainActivity : RootActivity(), NavigationView.OnNavigationItemSelectedListener, AnkoLogger {
    ...
    private val mGattUpdateReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                println("omggg before" )
                if (mGattCharacteristics != null) {
                    println("omggg after 1" )
    ...
    private val mServiceConnection = object : ServiceConnection {
        ...
        override fun onServiceConnected(componentName: ComponentName, service: IBinder) {
            ...
            println("blablalalbla " + mPrefs.getString("sensor_mac_address","address not found"))
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        println("it's appaaa before " + mPrefs.getString("sensor_name" , "sensor_name does not exist"))
        //APPA
        if (mPrefs.getString("sensor_name" , "sensor_name does not exist").toLowerCase().contains(regex = "^appa.".toRegex())) {
            println("it's appaaa " + mPrefs.getString("sensor_name" , "sensor_name does not exist"))
    ...
    override fun onDestroy() {
        ...
        if (mPrefs.getString("sensor_name" , "sensor_name does not exist").toLowerCase().contains(regex = "^ioio.".toRegex())) {
            ...
            // Send command to BLE
            if (MainActivity.mNotifyCharacteristic != null) {
                MainActivity.mNotifyCharacteristic!!.setValue("d")
